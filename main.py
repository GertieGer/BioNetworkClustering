...
fpath = r"C:\Users\blbl3\Documents\VM\louvain+splitting\out_file - "+dt_string+".csv"
f = open(fpath, "w")
...
netPath = r"C:\Users\blbl3\Documents\VM\Graphs\{0}\network.dat"
commPath = r"C:\Users\blbl3\Documents\VM\Graphs\{0}\community.dat"
    ...
    for n in n_vals:
        for mu in mu_vals:
            ...
            try:
                ...
                comms=[[] for i in range(0,max_value)]
                for node in dic:
                     comms[dic[node]-1].append(node)
                while ([] in comms):
                     comms.remove([])
